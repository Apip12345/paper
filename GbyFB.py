	...
	kecuali (KeyError, IOError):
		...
		jika 'save-device' di url:
			mencoba:
				...
				pick.close ()
				cetak '\ n \ 033 [1; 91m [\ 033 [1; 96m✓ \ 033 [1; 91m] \ 033 [1; 92mLogin berhasil' '
		...
		jika 'checkpoint' di url:
			cetak ("\ n \ 033 [1; 91m [!] \ 033 [1; 93mAccount Checkpoint")
			os.system ('rm -rf login.txt')
			waktu tidur (1)
			keluar()
		lain:
			print ("\ n \ 033 [1; 91m [!] Login Gagal")
			os.system ('rm -rf login.txt')
			waktu tidur (0,01)
			Gabung()
...
menu def ():
	os.system ('clear')
	mencoba:
		fb_token = buka ('login.txt', 'r'). read ()
	kecuali IOError:
		os.system ('clear')
		cetak "\ 033 [1; 91m [!] Token tidak ditemukan"
		os.system ('rm -rf login.txt')
		waktu tidur (0,01)
		Gabung()
	mencoba:
	...
	kecuali KeyError:
		os.system ('clear')
		cetak "\ 033 [1; 91m [!] \ 033 [1; 93mAccount Checkpoint"
		os.system ('rm -rf login.txt')
		waktu tidur (0,01)
		Gabung()
	kecuali requests.exceptions.ConnectionError:
		cetak "\ 033 [1; 91m [!] Tidak ada koneksi"
		keluar()
